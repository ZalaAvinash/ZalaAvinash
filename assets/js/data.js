...
export const portfolioData = {
  ...
  projects: [
    { id: 0, title: 'AIRIS Enterprise ERP', client: 'Aether Industries', impact: '70% faster deployments • Modernized from .NET 4.5 legacy', tech: ['.NET Core', 'Angular', 'Docker', 'Kubernetes'], desc: 'Full platform modernization. PRM module, real-time dashboards, container orchestration. 100k+ daily transactions now stable.', image: '/images/1.jpg', link: '#' },
    { id: 1, title: 'Insurance Portal Platform', client: 'Major Insurer', impact: '40k monthly users • 100% test coverage', tech: ['ASP.NET', 'MSSQL', 'HelloSign', 'Stripe'], desc: 'High-traffic customer portal. E-signature flows, payments, policy management. Zero downtime releases for 3 years.', image: '/images/2.jpg', link: '#' },
    { id: 2, title: 'Twitter Intelligence Engine', client: 'Internal Platform', impact: 'Executive dashboards • Real-time sentiment', tech: ['.NET Core', 'React', 'OpenAI', 'SignalR'], desc: 'Chrome extension + backend that turns Twitter into actionable intelligence. Featured for C-level reporting.', image: '/images/3.jpg', link: '#' },
    { id: 3, title: 'Real-time Trading Platform', client: 'Fintech Scale-up', impact: '<50ms latency @ 10k concurrent', tech: ['Angular', '.NET Core', 'Azure', 'Redis', 'SignalR'], desc: 'Low-latency trading terminal and matching engine. Sub-50ms roundtrips with full audit trail.', image: '/images/4.jpg', link: '#' },
    { id: 4, title: 'Legacy → Cloud Migration', client: 'Manufacturing Enterprise', impact: '40% infra cost reduction • 99.99% uptime', tech: ['ASP.NET', 'Docker', 'Kubernetes', 'Terraform'], desc: 'Moved 12-year-old monolith to cloud-native. Zero-downtime cutover with feature flags and canary deploys.', image: '/images/1.jpg', link: '#' }
  ],
